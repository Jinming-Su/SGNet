...
class LaneATTVP_lane_attenadd_fpn_refine_laneseg(nn.Module):
    def __init__(self,
                 backbone='resnet34',
                 ...
                 grid_pixel=20,
                 pixel_stride = 5):
        super(LaneATTVP_lane_attenadd_fpn_refine_laneseg, self).__init__()
        # Some definitions
...
class ResNet18(nn.Module):
    def __init__(self):
        ...
        res.load_state_dict(torch.load('resnet18-5c106cde.pth'))
