...
class LaneATTVP_lane_attenadd_more(nn.Module):
    def __init__(self,
                 backbone='resnet34',
        ...
        super(LaneATTVP_lane_attenadd_more, self).__init__()
        # Some definitions
...
#             self.anchor_feat_channels, fmap_w, self.fmap_h)
        ...
        self.conv0 = ConvBNReLU(backbone_nb_channels, backbone_nb_channels, 3, 1)
        self.conv1 = ConvBNReLU(backbone_nb_channels, self.anchor_feat_channels, 1, 0)
        self.conv2 = ConvBNReLU(self.anchor_feat_channels, backbone_nb_channels, 3, 1)
...
#         batch_anchor_features = torch.cat((attention_features, batch_anchor_features), dim=1)
        ...
        #end_time = time()
        return proposals_list, vp_logits, pred_vps, lane_logits
