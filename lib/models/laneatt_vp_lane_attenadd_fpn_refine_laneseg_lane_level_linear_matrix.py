...
class LaneATTVP_lane_attenadd_fpn_more_conv_refine_laneseg_lane_level_linear_matrix(nn.Module):
    def __init__(self,
                 backbone='resnet34',
                 ...
                 grid_pixel=20,
                 pixel_stride = 5):
        super(LaneATTVP_lane_attenadd_fpn_more_conv_refine_laneseg_lane_level_linear_matrix, self).__init__()
        # Some definitions
...
#         batch_anchor_features = torch.cat((attention_features, batch_anchor_features), dim=1)
    ...
    def loss(self, proposals_list, vp_logits, vp_preds, targets, vp_labels= None, lane_logits=None, lane_labels = None, h_paras = None, cls_loss_weight=10, lane_loss_weight=5, lane_level_loss_weight = 1, gaussian=True, base_offset_loss=1.0): 
