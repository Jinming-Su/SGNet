...
class LaneATTVP_base(nn.Module):
    def __init__(self,
                 backbone='resnet34',
        ...
        super(LaneATTVP_base, self).__init__()
        # Some definitions
        self.img_w = img_w
        self.img_h = img_h
        ...
        self.anchors, self.anchors_cut = self.generate_baseline_anchors()
...
#         batch_anchor_features = torch.cat((attention_features, batch_anchor_features), dim=1)
    ...
    def loss(self, proposals_list, vp_logits=None, vp_preds=None, targets=None, vp_labels= None, lane_logits=None, lane_labels = None, h_paras = None,  cls_loss_weight=10):
