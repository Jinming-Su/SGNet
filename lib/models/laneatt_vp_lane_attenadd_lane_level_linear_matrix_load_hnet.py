...
class LaneATTVP_lane_attenadd_lane_level_linear_matrix_load_hnet(nn.Module):
    def __init__(self,
                 backbone='resnet34',
        ...
        super(LaneATTVP_lane_attenadd_lane_level_linear_matrix_load_hnet, self).__init__()
        # Some definitions
...
#             self.anchor_feat_channels, fmap_w, self.fmap_h)
        ...
        #增加坐标映射矩阵的学习
        self.h_net = LaneATTVP_hnet()
        self.h_net.load_state_dict(torch.load('./experiments/hnet_order1/models/model_0005.pt')['model'])
...
#         batch_anchor_features = torch.cat((attention_features, batch_anchor_features), dim=1)
    ...
    def loss(self, proposals_list, vp_logits, vp_preds, targets, vp_labels= None, lane_logits=None, lane_labels = None, h_paras = None, cls_loss_weight=10, lane_level_loss_weight = 1): 
