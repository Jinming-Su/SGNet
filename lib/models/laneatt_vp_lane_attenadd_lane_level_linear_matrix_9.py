...
class LaneATTVP_lane_attenadd_lane_level_linear_matrix_9(nn.Module):
    def __init__(self,
                 backbone='resnet34',
        ...
        super(LaneATTVP_lane_attenadd_lane_level_linear_matrix_9, self).__init__()
        # Some definitions
