...
class LaneATTVP_lane_attenadd_fpn_more_conv_refine_laneseg(nn.Module):
    def __init__(self,
                 backbone='resnet34',
                 ...
                 grid_pixel=20,
                 pixel_stride = 5):
        super(LaneATTVP_lane_attenadd_fpn_more_conv_refine_laneseg, self).__init__()
        # Some definitions
...
#         pdb.set_trace()
        ...
        #lane_logits = self.decoder(feat_aspp) #self.lane_decoder(neck_features[0], feat_aspp)
...
class ResNet50(nn.Module):
    def __init__(self):
        ...
        res.load_state_dict(torch.load('resnet50-19c8e357.pth'))
        net = list(res.children())
        self.layer1 = nn.Sequential(*net[:4])
        self.layer2 = net[4]
        self.layer3 = net[5]
        self.layer4 = net[6]
