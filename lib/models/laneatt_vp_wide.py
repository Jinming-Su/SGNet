...
class LaneATTVP_wide(nn.Module):
    def __init__(self,
                 backbone='resnet34',
        ...
        super(LaneATTVP_wide, self).__init__()
        # Some definitions
...
#             self.anchor_feat_channels, fmap_w, self.fmap_h)
        ...
        self.cls_layer = nn.Linear(2 * self.anchor_feat_channels * self.fmap_h * 3, 2)
        self.reg_layer = nn.Linear(2 * self.anchor_feat_channels * self.fmap_h * 3, self.n_offsets + 1)
