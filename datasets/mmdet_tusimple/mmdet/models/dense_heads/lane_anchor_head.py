...
class LaneAnchorHead(BaseDenseHead):
    ...
    def __init__(self,
                 ...
                 anchor_generator=dict(
                     type='LaneAnchorGenerator',
                     scales=[4],
                     angles=range(0, 190, 10),
                     strides=[4, 8, 16, 32, 64]),
                 #CCTODO
                 bbox_coder=dict(
                     type='DeltaXYWABBoxCoder',
                 ...
                 train_cfg=None,
                 test_cfg=None):
        super(LaneAnchorHead, self).__init__()
    ...
    def _init_layers(self):
        ...
        self.line_conv_regress = nn.Sequential(
            nn.Conv2d(self.in_channels, 256, ks=3, padding=1),
            nn.Conv2d(256, 256, ks=3, padding=1))
    ...
    def forward(self, feats):
        ...
        line = self.line_regress(line)
        return (line, multi_apply(self.forward_single, feats))
