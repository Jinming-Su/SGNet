...
class LaneRPNHeadWOLine(LaneRPNTestMixin, LaneAnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(LaneRPNHeadWOLine, self).__init__(
...
#         print('sampling_result', sampling_result)
    ...
    def _get_bboxes_single(self,
        ...
        #proposals[:, 1] = ( proposals_tmp[:, 0] * (line[1]-line[0]) * 608 / 1600 + 608 * line[0] ).clamp(0, H-1)
